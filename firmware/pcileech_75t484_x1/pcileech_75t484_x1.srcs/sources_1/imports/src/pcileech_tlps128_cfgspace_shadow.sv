//
// Starlight DMA Firmware - Shadow CFG Space (Modified)
// Based on PCILeech FPGA by Ulf Frisk
//
// Shadow config space provides the full 4KB PCIe config space from BRAM,
// initialized from pcileech_cfgspace.coe (donor device dump).
// Write access is controlled by pcileech_cfgspace_writemask.coe.
//
// This module handles CfgRd0/CfgRd1 and CfgWr0/CfgWr1 TLPs when
// the shadow config space feature is enabled via dshadow2fifo.cfgtlp_en.
//
